...
//                (current_velocity_master_scaled-current_velocity_slave)*Bd.transpose()+ Human_force; // Human_force - Fe
        feeback_matrix -= r* Kd.transpose() +Human_force; // Human_force - Fe
    ...
    // weird mapping ( it is according to the joints because the force is applied to the joints)
